...
<body class="bg-[#eaf3f0] min-h-screen text-[15px] text-gray-800 flex">
    ...
    <div class="flex-1 flex flex-col min-h-screen">
        ...
        <!-- TOPBAR -->
        <header
            class="bg-white/95 backdrop-blur-md border-b border-gray-100 sticky top-0 z-30 px-6 py-4 flex items-center justify-between shadow-sm">
            <!-- KIRI -->
                ...
                <div class="bg-white rounded-2xl shadow-md border border-gray-200 overflow-hidden">
                    ...
                    <div class="px-6 py-4 flex justify-between items-center"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-white/60 text-[11px]">
                                    Semua data lamaran yang masuk ke JOBLYNX
                                </p>
                            </div>
                        ...
                        <div class="bg-white/20 text-white text-xs font-bold px-3 py-1.5 rounded-full">
                            Total: {{ count($applications) }} Lamaran
                        </div>
                        ...
                        <table class="w-full text-[13px]">
                            ...
                            <thead>
                                <tr style="background-color: #f0faf7; border-bottom: 2px solid #c6ead9;">
                                    ...
                                    <th
                                        class="px-5 py-3.5 text-left text-[11px] font-extrabold uppercase tracking-wider text-[#2d7f6a]">
                                        Pelamar
                                    </th>

                                    <th
                                        class="px-4 py-3.5 text-left text-[11px] font-extrabold uppercase tracking-wider text-[#2d7f6a]">
                                        Posisi
                                    </th>
                                    ...
                                    <tr class="hover:bg-[#f0faf7] transition-colors duration-150 group">
                                        ...
                                        <td class="px-5 py-4">
                                            ...
                                            <div class="flex items-center gap-3">
                                                ...
                                                bg-gradient-to-br from-[#2d7f6a] to-[#1a4450]
                                                ...
                                                <div>
                                                    ...
                                                    <div
                                                        class="font-bold text-[#1a4450] text-sm group-hover:text-[#2d7f6a] transition-colors">
                                                        {{ $app->nama_lengkap }}
                                                    </div>
                                        ...
                                        <td class="px-4 py-4">
                                            ...
                                            @if ($app->status == 'Diterima')
                                                <span
                                                    class="inline-flex items-center gap-1.5 bg-[#dcfce7] text-[#2d7f6a] px-3 py-1.5 rounded-full text-[10px] font-extrabold border border-[#a7f3d0]">
                                                    <span
                                                        class="w-1.5 h-1.5 rounded-full bg-[#2d7f6a] inline-block"></span>
                                                    DITERIMA
                                                </span>
                                            @elseif($app->status == 'Ditolak')
                                                <span
                                                    class="inline-flex items-center gap-1.5 bg-red-100 text-red-500 px-3 py-1.5 rounded-full text-[10px] font-extrabold border border-red-200">
                                                    <span
                                                        class="w-1.5 h-1.5 rounded-full bg-red-500 inline-block"></span>
                                                    DITOLAK
                                                </span>
                                            @elseif($app->status == 'Interview')
                                                <span
                                                    class="inline-flex items-center gap-1.5 bg-blue-100 text-blue-500 px-3 py-1.5 rounded-full text-[10px] font-extrabold border border-blue-200">
                                                    <span
                                                        class="w-1.5 h-1.5 rounded-full bg-blue-500 inline-block"></span>
                                                    INTERVIEW
                                                </span>
                                            @elseif($app->status == 'Diproses')
                                                <span
                                                    class="inline-flex items-center gap-1.5 bg-yellow-100 text-yellow-600 px-3 py-1.5 rounded-full text-[10px] font-extrabold border border-yellow-200">
                                                    <span
                                                        class="w-1.5 h-1.5 rounded-full bg-yellow-500 inline-block"></span>
                                                    DIPROSES
                                                </span>
                                            @else
                                                <span
                                                    class="inline-flex items-center gap-1.5 bg-gray-100 text-gray-500 px-3 py-1.5 rounded-full text-[10px] font-extrabold border border-gray-200">
                                                    <span
                                                        class="w-1.5 h-1.5 rounded-full bg-gray-400 inline-block"></span>
            ...
            <div id="deleteModal" class="fixed inset-0 bg-black/40 hidden items-center justify-center z-[999]">
                ...
                <div class="bg-white w-[360px] rounded-2xl shadow-xl p-6">
                    ...
                    <p class="text-sm text-gray-500 mb-5">
                        Yakin ingin menghapus data lamaran ini?
                    </p>
